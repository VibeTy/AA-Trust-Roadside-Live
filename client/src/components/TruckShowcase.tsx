    ...
    <section className="py-20 bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4">Our Mobile Service Fleet</h2>
          <p className="text-xl text-gray-300">
            Fully equipped trucks bringing professional automotive service directly to you
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute bottom-6 left-6">
              ...
              <p className="text-gray-200">Equipped with professional tools and diagnostic equipment</p>
            </div>
          </div>
          ...
          <div className="relative">
            <img 
              ...
              alt="AA Trust Roadside truck ready for emergency service"
              className="w-full h-80 object-cover rounded-xl shadow-2xl"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent rounded-xl"></div>
            <div className="absolute bottom-6 left-6">
              <h3 className="text-2xl font-bold text-white mb-2">Always Ready</h3>
              <p className="text-gray-200">Standing by 24/7 for your emergency roadside needs</p>
            </div>
          </div>
        </div>
