      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
            Mobile Truck Repair in Ormond Beach, Florida
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
            Professional heavy-duty diesel repair and emergency roadside assistance in the Birthplace of Speed
          </p>
          <div className="flex items-center justify-center text-gray-600 dark:text-gray-400 mb-8">
            <MapPin className="w-5 h-5 mr-2" />
            <span>Serving Ormond Beach, Volusia County, and Central Florida</span>
          </div>
        </div>
        ...
        <div className="prose prose-lg max-w-none mb-12 text-gray-700 dark:text-gray-300">
          <p>
            When you need dependable mobile truck repair in Ormond Beach, AA Trust Roadside delivers professional 
            roadside diesel help throughout the Birthplace of Speed and surrounding areas. From the historic beachfront 
            district near The Casements to the busy US-1 and A1A corridors, our certified diesel mechanics provide 
            24/7 emergency truck repair services. Whether you're broken down near Ormond Beach Municipal Airport, 
            stuck on I-95, or need service at your business location along Granada Boulevard, we bring fully equipped 
            mobile repair units directly to your location.
          </p>
          
          <p>
            Our Ormond Beach mobile truck repair specialists understand the demands of operating commercial vehicles 
            in this thriving coastal community. From delivery trucks serving the numerous resorts and golf courses 
            to heavy equipment working construction projects throughout northern Volusia County, we provide fast 
            roadside diesel help that keeps your business moving. Our mobile truck repair near Ormond-by-the-Sea, 
            Tomoka State Park, and the Ormond Beach Loop ensures minimal downtime for your operations, whether you're 
            hauling supplies to beachfront properties or transporting goods through the busy SR-40 interchange.
          </p>

          <p>
            Don't let a diesel breakdown slow you down in Ormond Beach. Our experienced team provides comprehensive 
            mobile truck repair services for all major diesel engines including Cummins, Caterpillar, Detroit Diesel, 
            and International. From emergency roadside diesel help near Rockefeller Gardens to scheduled maintenance 
            at your facility, we keep your heavy-duty trucks running reliably in Volusia County's coastal environment, 
            ensuring your business stays productive year-round.
          </p>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6 text-center">
            Our Ormond Beach Mobile Truck Repair Services
          </h2>
        ...
        <div className="bg-blue-600 text-white rounded-lg p-8 text-center">
          <h3 className="text-2xl font-bold mb-4">Need Emergency Roadside Diesel Help in Ormond Beach?</h3>
          <p className="text-lg mb-6">
            Our mobile truck repair professionals are standing by 24/7 to provide expert service anywhere in Ormond Beach.
          </p>
